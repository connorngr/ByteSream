    ...
    <footer className="bg-neutral-900 text-white py-12">
      <div className="container mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-neutral-400 mt-5">
              Thoughtful articles on technology, science, and culture.
            </p>
          </div>
          
          <FooterLinkGroup title="Categories">
        ...
        <div className="border-t border-neutral-800 mt-10 pt-6 text-center text-neutral-400 text-sm">
          <p>© {new Date().getFullYear()} ByteStream. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
...
type SocialIconProps = {
  type: 'twitter' | 'github' | 'instagram';
  href: string;
}

function SocialIcon({ type, href }: SocialIconProps) {
  return (
    <a href={href} className="text-neutral-400 hover:text-white transition">
